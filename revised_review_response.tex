...
\begin{itemize}
    ...
    \]
    where \texttt{stay} indicates that the vehicle remains in the same cluster as the previous round, and \texttt{switch} indicates it has changed clusters.
    ...
    \end{cases}
    \]
    This reward structure encourages stability in the low-distance cluster while penalizing frequent switching or persistent presence in the high-distance cluster, which are indicative of suspicious behavior.
\end{itemize}
